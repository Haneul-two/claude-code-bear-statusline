...
| 항목 | 의미 |
|---|---|
| `ʕ  ≧ᴥ≦  ʔ 행복` | 곰의 기분 — 1분마다 랜덤으로 바뀝니다 (아래 표 참고) |
...
다마고치처럼 **1분마다 기분이 랜덤으로** 바뀝니다. 한도 사용률과는 무관한 순수한 기분입니다.
...
- **기분 추가/변경**: `MOODS` 배열에 `{ eyes, word, color }`를 추가하거나 수정
